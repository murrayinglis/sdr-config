...
namespace hardware{
    void transmit_worker(uhd::usrp::multi_usrp::sptr tx_usrp, std::vector<std::complex<double>> buffers, double secondsInFuture)
    {
        transmitDoublesAtTime(tx_usrp, buffers, secondsInFuture);
    }
